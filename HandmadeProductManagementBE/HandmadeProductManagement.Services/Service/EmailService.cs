    ...
    : IEmailService
{
    ...
    public async Task SendPasswordRecoveryEmailAsync(string destMail, string passwordResetLink)
    {
        ...
        var emailContent = GeneratePasswordRecoveryHtmlContext(user!, passwordResetLink);
    ...
    public string GeneratePasswordRecoveryHtmlContext(ApplicationUser user, string passwordResetLink)
    {
